...
(function () {
  ...
  // Keep spinner visible — never show a false "failed" message while scripts load.
  setTimeout(function () {
  ...
  _flutter.loader.load({
    onEntrypointLoaded: async function (engineInitializer) {
      try {
        ...
        showBootError(
          'Could not start AgriSmartAI. Close this tab, run .\\scripts\\start-dev.ps1, then reopen http://localhost:8081'
        );
        console.error(err);
      }
    }
